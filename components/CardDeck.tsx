          ...
          <AnimatePresence mode="wait">
            {isShuffling ? (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="text-center py-16 lg:py-20 h-full flex flex-col items-center justify-center"
              >
                <motion.div
                  animate={{ rotate: 360 }}
              ...
              <motion.div
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="grid grid-cols-3 gap-3 pb-8 lg:grid-cols-4 lg:gap-4 h-full overflow-y-auto"
              >
